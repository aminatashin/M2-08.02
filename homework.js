...
const listLi = function(){


let unorderedList = document.getElementById('ul-list')
for (let i = 0 ; i<=6 ; i++){
let listItem = document.createElement('li')
listItem.Id = [i]
let parentDiv1= unorderedList.parentElement
parentDiv1.appendChild(listItem)
listItem.innerText = [genres]
